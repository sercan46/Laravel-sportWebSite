						...
						<div class="row mb-40">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div class="section-title">
									<h2 class="h6 header-color inline-block uppercase">ARAMA SONUÇLARI</h2>
								</div>
							</div>
						</div>
						<div class="row">
								...
								@if($sonuclar->count() <=0)
									<div class="col-md-12">
										<article class="zm-post-lay-a">
											<p style="font-weight: bold;color: darkred">Aradığınız Kelime İle İlgili Herhangi Bir İçerik Bulunamıştır.</p>
												<img src="/anasayfa/images/uzgun.png" style="width: 250px;height: 250px;padding-top: 15px"/>
                                        </article>
									</div>
								@else
						...
						<div class="row">
							...
							<aside class="zm-post-lay-f-area col-sm-6 col-md-12 col-lg-12 mt-70">
								<div class="row mb-40">
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
										<div class="section-title">
											<h2 class="h6 header-color inline-block uppercase">YENİ YORUMLAR</h2>
										</div>
									</div>
								</div>
								<div class="row">
